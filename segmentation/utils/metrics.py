...
if __name__ == '__main__':
    ...
    pix_acc = pixel_accuracy(pred, target, ignore_index)
    ...
    global_acc = global_pixel_accuracy(batch_preds, batch_targets, ignore_index)
    print(f"  Global pixel accuracy: {global_acc:.4f}")

    class_acc = class_pixel_accuracy(batch_preds, batch_targets, n_class, ignore_index)
    ...
    perfect_acc = global_pixel_accuracy(perfect_preds, batch_targets, ignore_index)
    print(f"  Perfect mIoU: {perfect_miou:.4f} (should be 1.0)")
    print(f"  Perfect pixel accuracy: {perfect_acc:.4f} (should be 1.0)")
    ...
    acc_batch8 = global_pixel_accuracy(all_preds, all_targets, ignore_index)
    ...
    print(f"  Batch size 8 - mIoU: {miou_batch8:.4f}, Pixel Acc: {acc_batch8:.4f}")
    ...
    single_acc = global_pixel_accuracy(single_pred, single_target, ignore_index)
    print(f"  Single image mIoU: {single_miou:.4f}")
    print(f"  Single image accuracy: {single_acc:.4f}")
